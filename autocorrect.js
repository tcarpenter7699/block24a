 ...
 */
const getClosestWord = (word, words, distanceFn, maxDistance) => {
  let closest = word;
 ...
 */
const getClosestWordByLength = (word, words, maxDistance) => {
  return getClosestWord(word, words, getDistanceByLength, maxDistance);
};
